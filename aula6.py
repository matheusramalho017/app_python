...
print('Diferenca entre 1: {}'.format(conjunto_diferenca))
print('Diferenca entre 2: {}'.format(conjunto_diferenca2))
...
lista = ['cachorro', 'cachorro', 'cachorro', 'gato', 'gato', 'gato','elefante']
